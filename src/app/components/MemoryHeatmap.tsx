...
export function MemoryHeatmap() {
  const topicStrengths: TopicStrength[] = [
    { topic: 'Neural Networks', strength: 90, category: 'strong' },
    { topic: 'Deep Learning', strength: 85, category: 'strong' },
    { topic: 'Backpropagation', strength: 88, category: 'strong' },
    { topic: 'Computer Vision', strength: 82, category: 'strong' },
    { topic: 'CNNs', strength: 82, category: 'strong' },
    { topic: 'NLP', strength: 78, category: 'moderate' },
    { topic: 'Transformers', strength: 70, category: 'moderate' },
    { topic: 'Data Structures', strength: 70, category: 'moderate' },
    { topic: 'Q-Learning', strength: 72, category: 'moderate' },
    { topic: 'Reinforcement Learning', strength: 65, category: 'weak' },
    { topic: 'Policy Gradients', strength: 58, category: 'weak' },
    { topic: 'Operating Systems', strength: 34, category: 'critical' },
  ];
